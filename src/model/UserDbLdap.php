...
namespace migcredit\Adldap2\model;
...
class UserDbLdap extends ActiveRecord implements IdentityInterface
{
     ...
     *   return [
     *       //...
     *       'LDAP-User-Sync-Options' => migcredit\Adldap2\model\UserDbLdap::SYNC_OPTIONS_TEMPLATE_WITHOUT_BACKEND_TASK,
     *       'LDAP-Group-Assignment-Options' => migcredit\Adldap2\model\UserDbLdap::GROUP_ASSIGNMENT_TOUCH_ONLY_MATCHING_REGEX,
     *       //...
     *   ];
     *
     ...
     *   return [
     *       //...
     *       'LDAP-Group-Assignment-Options' => migcredit\Adldap2\model\UserDbLdap::GROUP_ASSIGNMENT_TOUCH_ONLY_MATCHING_REGEX_WITH_ROLE,
     *       //...
     *   ];
     *
     *   With complete own settings
     ...
     *   return [
     *       //...
     *       'yii2-adldap-extension-Options' => migcredit\Adldap2\model\UserDbLdap::EXTENSION_OPTIONS_DEBUG,
     *       //...
     *   ];
     *
     *   With complete own settings
    ...
    const YII2_PROFILE_NAME = 'migcredit\Adldap2\model\UserDbLdap::';
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        if (static::getExtensionOptions('ENABLE_YII2_PROFILING') == true) {
            Yii::beginProfile('findIdentityByAccessToken', static::YII2_PROFILE_NAME . 'findIdentityByAccessToken');
        }

        //Database check. If no dataset is found then the only possible return value is null.
        $userObjectDb = static::findOne(['auth_key' => $token]);
     ...
     * \migcredit\Adldap2\model\UserDbLdap::findByAttribute('userPrincipalName',$this->username);
     ...
     * @return migcredit\Adldap2\model\UserDbLdap A User instance, if user is valid. Otherwise NULL.
     */
    ...
    /**
     * Check if a [[migcredit\Adldap2\model\UserDbLdap]] is allowed to login.
     ...
     *
     * @param migcredit\Adldap2\model\UserDbLdap $userObjectDb User object to validate.
     * @return migcredit\Adldap2\model\UserDbLdap A User instance if user is valid. Otherwise NULL.
     */
     ...
     * @return migcredit\Adldap2\model\UserDbLdap object. Null if the username is not found in LDAP.
     */
    public static function createNewUser($username, $individualGroupAssignmentOptions = null)
    {
        ...
        $userObjectDb->email = strtolower($username) . '@migcredit.ru';
